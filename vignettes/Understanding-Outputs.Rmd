...
knitr::include_graphics('/ix/djishnu/Aaron/1_general_use/SLIDE/examples/out/0.01_1_out/ControlPerfomancePlot.png')
```
...
knitr::include_graphics('/ix/djishnu/Aaron/1_general_use/SLIDE/examples/out/0.01_1_out/plotSigGenes_marginals.png')
```
...
knitr::include_graphics('/ix/djishnu/Aaron/1_general_use/SLIDE/examples/out/0.01_1_out/plotSigGenes.png')
```
...
Here, `Z97` interacts with both `Z147` and `Z109`; `Z46`, `Z58`, `Z129`, and `Z137` have no interactions
...
knitr::include_graphics('/ix/djishnu/Aaron/1_general_use/SLIDE/examples/out/0.01_1_out/plotInteractions.png')
```
...
gene_list = read.csv('examples/out/0.01_1_out/gene_list_Z97.txt',
                     row.names = 1)
knitr::kable(head(gene_list))
```

```{r actual_load_gene_list, echo = F, fig.align="center"}
gene_list = read.table('/ix/djishnu/Aaron/1_general_use/SLIDE/examples/out/0.01_1_out/gene_list_Z97.txt',
...
SLIDE_LFs = readRDS('/ix/djishnu/Aaron/1_general_use/SLIDE/examples/out/0.01_1_out/SLIDE_LFs.rds')
names(SLIDE_LFs)
```
