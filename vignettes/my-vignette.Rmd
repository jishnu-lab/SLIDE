...
![Example YAML file for ordinal/continuous Y.](test_yaml_example.png)

![Example YAML file for binary Y.](Screen%20Shot%202024-02-14%20at%2010.48.53%20AM.png){width="200" height="282"}
...
Optimize_SLIDE(input_params, sink_file = TRUE)
```
...
First investigate the summary_table.csv. Thi
