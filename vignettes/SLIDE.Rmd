...
![Example Yaml (Continuous Y)](build_files/continuous_yaml_example.png)

![Example Yaml (Binary Y)](build_files/binary_yaml_example.png){width="225" height="340"}
...
```{r name3, warning=FALSE, results = 'hide'}
...
`SLIDE::SLIDEcv(yaml_path="/ix/djishnu/Javad/SLIDEDir_Lab/SLIDE/vignettes/sample.yaml",nrep=20,k=10)`
